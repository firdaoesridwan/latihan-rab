<?php $title = "Manajemen Pengguna - RAB"; ?>
...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
    <div class="container px-6 py-8 mx-auto">
        <h3 class="text-3xl font-medium text-gray-700">Manajemen Pengguna</h3>
                    ...
                    <div class="flex flex-col w-full h-auto ">
                        ...
                        <form>
                            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                                ...
                                <div>
                                    <label class="text-black" for="passwordConfirmation">Jabatan</label>
                                ...
                                <div>
                                    <label class="text-black" for="emailAddress">Username</label>
