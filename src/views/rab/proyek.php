...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
    <div class="container px-6 py-8 mx-auto">
        <h3 class="text-3xl font-medium text-gray-700">Proyek RAB</h3>
                    ...
                    <div class="flex flex-col w-full h-auto ">
                        ...
                        <form>
                            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-1">
                                <div>
                                    <label class="text-black" for="username">ID Proyek</label>
                                ...
                                <div>
                                    <label class="text-black" for="emailAddress">Judul</label>
                                ...
                                <div>
                                    <label class="text-black" for="emailAddress">Divisi</label>
                                    <input id="emailAddress" type="email" class="block w-full px-4 py-2 mt-2 text-black bg-white border border-gray-400 rounded-md focus:border-blue-500 focus:outline-none focus:ring">
                                </div>
                            </div>
